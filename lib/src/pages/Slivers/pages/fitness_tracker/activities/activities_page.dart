import 'package:componentes/src/pages/Slivers/pages/fitness_tracker/activities/activity_card.dart';
import 'package:componentes/src/pages/Slivers/pages/fitness_tracker/activities/profile_header.dart';
...
class ActivitiesPage extends StatelessWidget {
  ...
  static const sampleActivities = <Activity>[
     ...
     Activity(
      ...
      distance: '10.37 km',
      pace: '4:54 /km',
      time: '50m 52s', description: 'jl', splits: [],
    ),
    Activity(
      dateTime: 'July 29, 2019 at 11:19 AM',
      distance: '11.00 km',
      pace: '4:59 /km',
      time: '54m 51s', description: '', splits: [],
    ),
    Activity(
      dateTime: 'July 26, 2019 at 9:40 AM',
      distance: '8.14 km',
      pace: '4:57 /km',
      time: '50m 19s', splits: [], description: '',
    ),
  ];
